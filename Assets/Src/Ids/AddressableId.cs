...
namespace Game.Ids
{
	public enum AddressableId
	{
		...
		Addressables_Prefabs_UI_Win_Screen,
	...
	public static class AddressableConfigLookup
	{
			...
			{"GenerateIds", new List<AddressableConfig>
				{
					...
					new AddressableConfig(2, "Addressables/Prefabs/UI/Win Screen.prefab", "Assets/Addressables/Prefabs/UI/Win Screen.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"}),
					new AddressableConfig(3, "Addressables/Prefabs/UI/Pause PopUp.prefab", "Assets/Addressables/Prefabs/UI/Pause PopUp.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"}),
					new AddressableConfig(4, "Addressables/Prefabs/UI/MainHud.prefab", "Assets/Addressables/Prefabs/UI/MainHud.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"}),
					new AddressableConfig(5, "Addressables/Prefabs/UI/Main Menu.prefab", "Assets/Addressables/Prefabs/UI/Main Menu.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"}),
					...
					new AddressableConfig(8, "Addressables/Prefabs/UI/Compliance Screen.prefab", "Assets/Addressables/Prefabs/UI/Compliance Screen.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"}),
		...
		private static readonly IList<AddressableConfig> _addressableConfigs = new List<AddressableConfig>
		{
			...
			new AddressableConfig(10, "Addressables/Prefabs/UI/Win Screen.prefab", "Assets/Addressables/Prefabs/UI/Win Screen.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"}),
